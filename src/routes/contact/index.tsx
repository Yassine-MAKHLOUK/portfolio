...
export default component$(() => {
  return (
    <>
      <div class="contact-banner flex justify-center items-center w-screen h-screen pt-40"></div>
      <div class="flex justify-center items-center w-screen h-screen">
        <div class="container mx-auto my-4 px-4 lg:px-20">

          <div class="w-full p-8 my-4 bg-black md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
            <div class="flex">
